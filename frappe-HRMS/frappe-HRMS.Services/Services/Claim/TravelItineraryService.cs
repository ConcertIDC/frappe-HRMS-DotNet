...
{
    public class TravelItineraryService : GenericService<TravelItinerary>, ITravelItineraryService
    {
        public TravelItineraryService(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
