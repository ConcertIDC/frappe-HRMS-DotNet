...
{
    public class AdvancePaymentService : GenericService<AdvancePayments>, IAdvancePaymentService
    {
        public AdvancePaymentService(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
