...
namespace frappe_HRMS.Infrastructure.Migrations
{
    ...
    [Migration("20250303133839_update_dataType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.AdvancePayments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.EmployeeAdvance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("RepayUnclaimedAmountfromSalary")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.ModeOfPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.TaxesAndCharges", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Company.Company", b =>
                {
                    ...
                    b.Property<string>("ArrearComponent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BasicComponent")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DefaultBuyingTerms")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultEmployeeAdvanceAccount")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultOperatingCostAccount")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultSellingTerms")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultWarehouseSalesReturn")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("HRAComponent")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Employee.EmployeeAddress", b =>
                {
                    ...
                    b.Property<string>("CurrentAddressIs")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PermanentAddressIs")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.ProjectTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.ProjectType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.ProjectUpdate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.ActivityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("DefaultCostingRate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.BillingDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("BillingHours")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("TotalBillableAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.TimeSheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.TimeSheetList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.AccountingDetails", b =>
                {
                    ...
                    b.HasOne("frappe_HRMS.Domain.Projects.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.AdvancePayments", b =>
                {
                    b.HasOne("frappe_HRMS.Domain.Claim.EmployeeAdvance", "EmployeeAdvance")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.EmployeeAdvance", b =>
                {
                    ...
                    b.HasOne("frappe_HRMS.Domain.Claim.ModeOfPayment", "ModeOfPayment")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.Expenses", b =>
                {
                    b.HasOne("frappe_HRMS.Domain.Claim.ExpenseClaim", "ExpenseClaim")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Claim.TaxesAndCharges", b =>
                {
                    b.HasOne("frappe_HRMS.Domain.Claim.Account", "AccountHead")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.Projects.Project", b =>
                {
                    ...
                    b.HasOne("frappe_HRMS.Domain.Projects.ProjectTemplate", "ProjectTemplate")
                        .WithMany()
                        .HasForeignKey("ProjectTemplateId");

                    b.HasOne("frappe_HRMS.Domain.Projects.ProjectType", "ProjectType")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.TimeSheet", b =>
                {
                    b.HasOne("frappe_HRMS.Domain.TimeSheets.BillingDetails", "BillingDetails")
                        .WithMany()
            ...
            modelBuilder.Entity("frappe_HRMS.Domain.TimeSheets.TimeSheetList", b =>
                {
                    b.HasOne("frappe_HRMS.Domain.TimeSheets.ActivityType", "ActivityType")
                        .WithMany()
                    ...
                    b.HasOne("frappe_HRMS.Domain.TimeSheets.TimeSheet", "TimeSheet")
                        .WithMany("TimeSheets")
