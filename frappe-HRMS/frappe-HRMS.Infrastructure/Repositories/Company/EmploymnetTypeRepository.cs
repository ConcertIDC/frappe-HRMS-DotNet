...
{
    internal class EmploymnetTypeRepository : GenericRepository<EmploymentType>, IEmploymentTypeRepository
    {
        public EmploymnetTypeRepository(HRMSDbContext context) : base(context)
        {
        }
    }
}
